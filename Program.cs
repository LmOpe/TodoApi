...
totoItems.MapGet("/", GetAllTodos);

totoItems.MapGet("/complete", GetCompleteTodos);

totoItems.MapGet("/{id}", GetTodo);

totoItems.MapPost("/", CreateTodo);

totoItems.MapPut("/{id}", UpdateTodo);

totoItems.MapDelete("/{id}", DeleteTodo);
